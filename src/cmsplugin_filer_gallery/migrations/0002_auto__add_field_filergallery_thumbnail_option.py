...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'FilerGallery.thumbnail_option'
        db.add_column('cmsplugin_filergallery', 'thumbnail_option', self.gf('django.db.models.fields.related.ForeignKey')(default=0, to=orm['cmsplugin_filer_image.ThumbnailOption']), keep_default=False)

    def backwards(self, orm):
        
        # Deleting field 'FilerGallery.thumbnail_option'
        db.delete_column('cmsplugin_filergallery', 'thumbnail_option_id')
    ...
    models = {
        ...
        'cmsplugin_filer_gallery.filergallery': {
            ...
            'thumbnail_option': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['cmsplugin_filer_image.ThumbnailOption']"}),
