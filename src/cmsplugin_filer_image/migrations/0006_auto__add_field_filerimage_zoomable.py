...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'FilerImage.zoomable'
        db.add_column('cmsplugin_filerimage', 'zoomable', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)

    def backwards(self, orm):
        
        # Deleting field 'FilerImage.zoomable'
        db.delete_column('cmsplugin_filerimage', 'zoomable')
